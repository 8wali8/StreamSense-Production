...
from ml_engine import metrics
from ml_engine.frame_store import FrameArtifactError, readable_frame_ref
...
from ml_engine.registry import BackendRegistry, ModelNotReadyError
from ml_engine.relevance import SponsorRelevanceInput
from ml_engine.settings import Settings, get_settings
from ml_engine.sponsor import SponsorDetectionContext
from ml_engine.transcription import TranscriptionError
...
def _configure_logging() -> None:
    ...
    where the process is started by ``uvicorn ml_engine.main:app``.
    """
...
# Module-level app for `uvicorn ml_engine.main:app`; construction does no I/O, the lifespan does.
app = create_app()
