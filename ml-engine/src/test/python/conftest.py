...
from app.main import create_app, get_registry
from app.registry import BackendInfo
from app.relevance import SponsorRelevanceInput, SponsorRelevanceResult
...
from app.sponsor import DeterministicSponsorDetector
