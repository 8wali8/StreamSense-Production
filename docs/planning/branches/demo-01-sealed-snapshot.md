...
|---|---|---|
| Frontend gate | `npm run codegen:check`, `lint`, `format:check`, `test:coverage`, `build` | all pass; 118 tests; statements 87.5 %, branches 81.09 %; the snapshot builds as its own 1.2 MB chunk (149 KB gzipped) loaded only on `/demo` |
