...
- `sponsor-logo-detection.md`: the scope for real sponsor logo detection against the deal's uploaded logo (branches `logo/01` to `logo/07`): where the PRD lands in the code, decisions, verification ladder, branch sequence, risks, open questions.
