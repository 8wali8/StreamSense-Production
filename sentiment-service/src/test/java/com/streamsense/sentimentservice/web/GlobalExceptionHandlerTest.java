package com.streamsense.sentimentservice.web;
...
class GlobalExceptionHandlerTest {
    ...
    private final GlobalExceptionHandler handler = new GlobalExceptionHandler("sentiment-service");
    ...
    void illegalArgumentBecomesA400ProblemWithServiceAndInstance() {
        ...
        assertThat(problem.getProperties()).containsEntry("service", "sentiment-service").containsEntry("correlationId", "corr-123");
    ...
    void frameworkErrorsGetAStableStreamSenseType() throws Exception {
        ...
        assertThat(((ProblemDetail) malformed.getBody()).getProperties()).containsEntry("service", "sentiment-service");
