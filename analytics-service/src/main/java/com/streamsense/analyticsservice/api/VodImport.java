 ...
 * capture replays were started, anything that went wrong on the way, and the import's status as
 * recorded. The events arrive over the following minutes; the session's numbers fill in as they do.
 */
