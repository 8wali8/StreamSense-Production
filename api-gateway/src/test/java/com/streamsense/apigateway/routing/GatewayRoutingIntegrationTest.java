...
class GatewayRoutingIntegrationTest {
    ...
    void proxiesChatIngestThroughCentralGatewayRoute() throws Exception {
        CHAT_SERVICE.enqueue(new MockResponse()
                .addHeader("Content-Type", "application/json")
                .setBody("{\"eventId\":\"evt-123\"}"));
        ...
        webTestClient().post()
                ...
                .exchange()
                .expectStatus().isOk()
                .expectHeader().valueEquals("X-StreamSense-Route-Id", "chat-service-api")
                .expectBody()
                .jsonPath("$.eventId").isEqualTo("evt-123");
