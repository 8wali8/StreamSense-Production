...
public class SentimentGraphqlController {
    ...
    public SentimentGraphqlController(
            SentimentServiceClient sentimentServiceClient, SentimentSubscriptionBus sentimentSubscriptionBus) {
    ...
    public Flux<SentimentAnalysisEvent> onSentiment(@Argument("streamer") String streamer) {
        ...
        return sentimentSubscriptionBus.flux().filter(event -> streamer.equals(event.getStreamer()));
    }
    ...
    public Flux<SentimentAnalysisEvent> onSponsorSentiment(
        ...
        return sentimentSubscriptionBus
                .flux()
