...
public class SponsorGraphqlController {
    ...
    public SponsorGraphqlController(
            VideoServiceClient videoServiceClient, SponsorSubscriptionBus sponsorSubscriptionBus) {
    ...
    public Flux<SponsorDetectionEvent> onSponsorDetection(@Argument("streamer") String streamer) {
        ...
        return sponsorSubscriptionBus.flux().filter(event -> streamer.equals(event.getStreamer()));
    }
}
