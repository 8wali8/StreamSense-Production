...
public class TranscriptGraphqlController {
    ...
    public TranscriptGraphqlController(
            SentimentServiceClient sentimentServiceClient, TranscriptSubscriptionBus transcriptSubscriptionBus) {
    ...
    public Mono<List<TranscriptSentimentEvent>> recentSponsorTranscriptSentiment(
            @Argument("streamer") String streamer, @Argument("sponsor") String sponsor, @Argument("limit") int limit) {
    ...
    public Flux<TranscriptSegmentEvent> onTranscriptSegment(@Argument("streamer") String streamer) {
        ...
        return transcriptSubscriptionBus.transcriptFlux().filter(event -> streamer.equals(event.getStreamer()));
    }
