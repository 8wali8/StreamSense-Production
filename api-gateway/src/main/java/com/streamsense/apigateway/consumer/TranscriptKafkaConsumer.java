...
public class TranscriptKafkaConsumer {
    ...
    public void onTranscriptSegment(TranscriptSegmentEvent event) {
        log.info("gateway consumed transcript segmentId={} streamer={} textLength={}",
                event.getSegmentId(), event.getStreamer(), event.getText() != null ? event.getText().length() : 0);
    ...
    public void onTranscriptSentiment(TranscriptSentimentEvent event) {
        log.info("gateway consumed transcript sentimentEventId={} streamer={} label={}",
