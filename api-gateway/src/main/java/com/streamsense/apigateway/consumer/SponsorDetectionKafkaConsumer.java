...
public class SponsorDetectionKafkaConsumer {
    ...
    @KafkaListener(
            topics = "${streamsense.topics.sponsorDetections}",
            containerFactory = "sponsorKafkaListenerContainerFactory")
    public void onMessage(SponsorDetectionEvent event) {
        log.info(
                "gateway consumed sponsor detectionEventId={} streamer={} sponsor={}",
