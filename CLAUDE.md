...
| analytics-service | 8085 | Java | Aggregates stream metrics from event streams; owns stream sessions (Twitch Helix poller or capture-derived), deals, and the session and deal report summaries |
