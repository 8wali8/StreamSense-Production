...
| analytics-service | 8085 | Java | Aggregates stream metrics from event streams; owns stream sessions (Twitch Helix poller, capture-derived, or imported from a recording), deals, VOD imports, and the session and deal report summaries |
