...
class GlobalExceptionHandlerTest {
    ...
    private final GlobalExceptionHandler handler = new GlobalExceptionHandler("recommendation-service");
    ...
    void illegalArgumentBecomesA400ProblemWithServiceAndInstance() {
        ...
        assertThat(problem.getProperties()).containsEntry("service", "recommendation-service").containsEntry("correlationId", "corr-123");
    ...
    void frameworkErrorsGetAStableStreamSenseType() throws Exception {
        ...
        assertThat(((ProblemDetail) malformed.getBody()).getProperties()).containsEntry("service", "recommendation-service");
